...
//util utk mempermudah akses API di belakangnya
@Component
public class RestTemplateUtil { //buat kelas ini agar memudahkan ga perlu panggil http berulang2
    ...
    //<T> menandakan bisa ke semua kelas, sifatnya dinamik
